...
public interface Constant
{
    ...
    public final String CERTIFICATION_FRAGMENT = "CERTIFICATION_FRAGMENT";
    
    public final String FROM_ACTIVITY = "FROM_ACTIVITY";

    public final String SUBJECT_ACTIVITY = "SUBJECT_ACTIVITY";

    public final String STATISTIC_ACTIVITY = "STATISTIC_ACTIVITY";

    public final String PROFILE_ACTIVITY = "PROFILE_ACTIVITY";

    public final String MATERIALS_ACTIVITY = "MATERIALS_ACTIVITY";

    public final String NODE_BY_NODE_ACTIVITY = "NODE_BY_NODE_ACTIVITY";

    public final String LECTURE_ACTIVITY = "LECTURE_ACTIVITY";


    public final String COLOR_UNSELECTED_SUBJECT = "#677984";
