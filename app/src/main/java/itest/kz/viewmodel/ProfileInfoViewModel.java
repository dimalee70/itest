...
public class ProfileInfoViewModel extends BaseObservable
{
    ...
    public ObservableInt checkMark = new ObservableInt(View.GONE);
...
//        notifyChange();
    ...
    public ObservableInt getCheckMark() {
        return checkMark;
    }
    ...
    public void setCheckMark(boolean check) {
        if (check)
        {
            checkMark.set(View.VISIBLE);
        }
        else
        {
            checkMark.set(View.GONE);
        }
    }
...
//        notifyChange();
    ...
    {
        return R.string.hintEmail;
    }

    public int getHintLoginText()
    {
        return R.string.hintLogin;
    }

    public int getLoginEmailHeader()
    {
        return R.string.loginEmailHeader;
    }

    public int getHintDateOfBirthText()
    {
        return R.string.hintDateOfBirth;
    }
    ...
    public int getHintSurnameText()
    {
        ...
        return R.string.hintSurname;
    }
    public int getSurnameText()
    {

        return R.string.surname;
    }

    public int getHintNameText()
    {
        return R.string.hintName;
    }
