...
public class FullTestStatisticViewModel extends Observable
{
    ...
    public  ObservableInt relative = new ObservableInt(View.GONE);
    ...
    public FullTestStatisticViewModel(Context context)
    {
...
//        settings.edit().clear().commit();
    ...
    private void fetchSubjectStatisticList()
    {
        if (CheckUtility.isNetworkConnected(context)) {
            ...
            Disposable disposable = subjectService.getStatisticFull(
                    language)
